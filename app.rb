...
list.add("todo", "Buy more cat food", due_date: "2016-02-03", priority: "low")
list.add("todo", "Sweep floors", due_date: "2016-01-30")
...
new_list.add("todo", "Buy more dog food", due_chronic: "in 5 weeks", priority: "medium")
new_list.add("todo", "Go dancing", due_chronic: "in 2 hours")
...
# new_list.postpone(1, 2)
# new_list.all

# DEMO FILTER BY ITEM TYPE
# ------------------------
new_list.filter("event")
# new_list.filter("event").each do |e|
#   puts e.details
# end
